    ...
    <div className="App">
      <header className="App-header">
        <BrowserRouter>
          <Menu/>
          <Routes>
            <Route index element={<Home dataForThisPage={address} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="*" element={<PageNotFound />} />

            <Route path="Address" element={<Address dataForThisPage={address} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} updateFormVisibleMethodForThisPage = {updateFormVisible} addFormVisibleForTheAddFormOfThisPage = {addFormVisible} setAddFormVisibleForTheTableOfThisPage = {SetAddFormVisible} />} />
            <Route path="AddressesList" element={<AddressesList dataForThisPage={addressesList} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="AddressType" element={<AddressType dataForThisPage={addressType} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="BaseCurrency" element={<BaseCurrency dataForThisPage={baseCurrency} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="BaseUnitOfMeasurement" element={<BaseUnitOfMeasurement dataForThisPage={baseUnitOfMeasurement} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="CorporateEntity" element={<CorporateEntity dataForThisPage={corporateEntity} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="CurrencyQuotation" element={<CurrencyQuotation dataForThisPage={currencyQuotation} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="CustomersSupplier" element={<CustomersSupplier dataForThisPage={customersSupplier} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="Inventory" element={<Inventory dataForThisPage={inventory} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="NaturalPearson" element={<NaturalPearson dataForThisPage={naturalPearson} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="Order" element={<Order dataForThisPage={order} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="OrderStatusChange" element={<OrderStatusChange dataForThisPage={orderStatusChange} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="OrderStatus" element={<OrderStatus dataForThisPage={orderStatus} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="Product" element={<Product dataForThisPage={product} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="ProductListItem" element={<ProductListItem dataForThisPage={productListItem} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="ProductsListItemStatusChange" element={<ProductsListItemStatusChange dataForThisPage={productsListItemStatusChange} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="ProductsListItemStatus" element={<ProductsListItemStatus dataForThisPage={productsListItemStatus} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="Shipment" element={<Shipment dataForThisPage={shipment} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="ShipmentStatusChange" element={<ShipmentStatusChange dataForThisPage={shipmentStatusChange} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="ShipmentStatus" element={<ShipmentStatus dataForThisPage={shipmentStatus} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
            <Route path="VariableUnitOfMeasurement" element={<VariableUnitOfMeasurement dataForThisPage={variableUnitOfMeasurement} updatingFormMethodForThisPage={changeDataToPlaceInTheUpdatingForm} updatingFormObjectForThisPage={editingFormObject} onPutMethod={onPutForm} />} />
